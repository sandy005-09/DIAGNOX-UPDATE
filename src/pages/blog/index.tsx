...
const blogPosts: BlogPost[] = [
  ...
  {
    id: '5',
    title: 'How Predictive Maintenance is Transforming Truck Fleet Operations',
    excerpt: 'Modern transport fleets cannot afford unexpected breakdowns. This article explains how predictive vehicle health monitoring helps fleet operators reduce downtime, cut maintenance costs, and improve operational efficiency.',
    date: 'February 24, 2026',
    author: 'DiagnoX Team',
    category: 'Predictive Maintenance / Fleet Management',
    readTime: '6 min read',
    slug: 'predictive-maintenance-transforming-truck-fleet',
  },
];
